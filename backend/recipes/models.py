...
from .constants import (
    ...
    VERBOSE_TIME_RECIPE, VERBOSE_LINK_RECIPE, RECIPE_VERBOSE,
    RECIPE_VERBOSE_PLURAL, VERBOSE_RECIPE_RI, VERBOSE_INGREDIENT_RI,
    VERBOSE_AMOUNT_RI, RI_VERBOSE, RI_VERBOSE_PLURAL, VERBOSE_USER_FAVORITE,
    VERBOSE_RECIPE_FAVORITE, FAVORITE_VERBOSE, FAVORITE_VERBOSE_PLURAL
)
